...
import com.example.ejquedadas.ListadoAsistencia
import com.example.ejquedadas.MapsActivity
import com.example.ejquedadas.R
import com.google.firebase.firestore.ktx.firestore
import com.google.firebase.ktx.Firebase

class MiAdaptadorRecyclerCon (var eventos : ArrayList<Evento>,var  context: Context) : RecyclerView.Adapter<MiAdaptadorRecyclerCon.ViewHolder>() {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(
            ...
            context: Context,
            pos: Int,
            miAdaptadorRecycler: MiAdaptadorRecyclerCon
        ) {
            ...
            itemView.setOnClickListener(
                View.OnClickListener
                {
                    ...
                    /*Toast.makeText(
                        context,
                        "Valor seleccionado " + MiAdaptadorRecyclerCon.seleccionado.toString(),
                        Toast.LENGTH_SHORT
                    ).show()*/

                    var intentV1 = Intent(context,ListadoAsistencia::class.java)
