...
class VentanaConsulta : AppCompatActivity() {
    ...
    var miAdapter = MiAdaptadorRecyclerConsultas(miArray, this)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //recyclerView
        recycler_eventos = findViewById(R.id.recyclerViewConsultar) as RecyclerView
