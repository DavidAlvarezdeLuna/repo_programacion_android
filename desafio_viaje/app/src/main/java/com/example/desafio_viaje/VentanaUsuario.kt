...
class VentanaUsuario : AppCompatActivity() {
    ...
    var miAdapter = MiAdaptadorRecyclerUsuarioEventos(miArray, this)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //recyclerView
        recycler_eventos = findViewById(R.id.recycler_usuario_eventos) as RecyclerView
    ...
    fun verPerfil(view:View){
        var intentV1 = Intent(this, VentanaPerfil::class.java)
