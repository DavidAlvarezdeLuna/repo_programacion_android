...
class Internista(nidi:Int? = null, nombre:String? = null, listaSeguros:ArrayList<String>? = null):Medico(nidi,nombre,listaSeguros) {
    ...
    class Builder(var nidi:Int? = null, var nombre:String? = null, var listaSeguros:ArrayList<String>? = null){
        ...
        fun build():Internista{
            return Internista(nidi,nombre,listaSeguros)
        }
